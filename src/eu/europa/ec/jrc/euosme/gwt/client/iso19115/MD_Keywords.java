...
public class MD_Keywords extends CI {
	...
	/** keyword uri control declaration */
	CharacterString uriObj = new CharacterString(constants.URI(),"", false, CheckFunctions.normal, true);
	...
	public void setFormName(String name) {
		...
		uriObj.setFormName(name + ".keyword[1].@gco:nilreason");		
