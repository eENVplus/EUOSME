...
public interface RESTfulWebServiceProxy extends RemoteService {
    ...
    public String invokeGetRESTfulWebService(String uri, String contentType, String clientLanguage, String filter, String repoType)
	...
	eu.europa.ec.jrc.euosme.gwt.client.callback.GeonetworkServiceRpcCallback.returnType invokeHarvestService(
			String url, String XMLTree, String filename, String clientLanguage) throws RESTfulWebServiceException;

	eu.europa.ec.jrc.euosme.gwt.client.callback.GeonetworkLoginServiceRpcCallback.returnType invokeLoginService(
			String username, String password);

	eu.europa.ec.jrc.euosme.gwt.client.callback.GeonetworkServiceRpcCallback.returnType invokeMetadataGetService(
			String url) throws RESTfulWebServiceException;

	public String invokeResolveThesaurus(String scheme, String conceptURI) throws RESTfulWebServiceException;

	eu.europa.ec.jrc.euosme.gwt.client.callback.GeonetworkServiceRpcCallback.returnType invokeHarvestService(
			String username, String password, String url, String XMLTree, String filename, String clientLanguage) throws RESTfulWebServiceException;
