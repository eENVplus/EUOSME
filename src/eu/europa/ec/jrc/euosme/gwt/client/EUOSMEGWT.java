...
public class EUOSMEGWT implements EntryPoint {
	...
	public static String apiMapstraction = "openlayers"; //"google"; MG 30.04.2015
	...
	/** true, the application uses the online repositories; false, the application uses the local resources */
	public static String wmsEndpoint = "http://vmap0.tiles.osgeo.org/wms/vmap0";
	
	/** password to access the editor */
	public static String euosmePassword = "#EENVPLUS!";	//"Geosmartcity2014";//
	...
	public static boolean readyToAccess = false;
	...
	/** Indicates the availability of Geonetwork services */
	public static boolean gnserviceAvailable = true;
	/** In development mode to enable only a certain tab **/
	public static String devMode = "all";
	...
	public static void startup() {		
			...
			if (apiMapstraction.equalsIgnoreCase("google")) {
				...
				if (GWT.getHostPageBaseURL().toLowerCase().startsWith("http://showcase.eenvplus.eu")) AjaxLoader.init("AIzaSyDDNGucX-HYCLnzvihqfmO09cimLAit7QQ");
	...
	public static void inputPassword() {
		...
		Button okButton = new Button(constants.okButton(), new ClickHandler() {			
			...
			public void onClick(ClickEvent event) {	
				if(txtPassword.getValue().equalsIgnoreCase(euosmePassword)) {
					resourceDialog.hide();	
					lblMessage.setText("");
					EUOSMEGWT.chooseResourceType();
				} else {
					lblMessage.setText(constants.wrongPassword());
				}
			}
		});		    
		...
		resourceDialog.setHTML("<b>" + constants.inputPassword() + "</b><br/>");
