...
public class MD_Medium extends CI {
	...
	public MD_Medium(String label, boolean required, boolean multiple, String help) {
		...
		specificationObj.myTextBox.getValueBox().addBlurHandler(new BlurHandler() {
			@Override
			public void onBlur(BlurEvent event) {
				TreeItem myTreeItem = null;
				myTreeItem = Utilities.getSelectTreeItem(specificationObj.myTextBox.getValueBox().getName());					
				if (myTreeItem!=null) {
