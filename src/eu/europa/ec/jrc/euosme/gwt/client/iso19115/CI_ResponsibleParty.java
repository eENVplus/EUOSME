...
public class CI_ResponsibleParty extends CI {
	...
	public void myCheck() {
		...
		if (!(EUOSMEGWT.appMode.equalsIgnoreCase(AppModes.EENVPLUS.toString()) || EUOSMEGWT.appMode.equalsIgnoreCase(AppModes.GEOSS.toString()) || EUOSMEGWT.appMode.equalsIgnoreCase(AppModes.GEOPORTAL.toString()) || EUOSMEGWT.appMode.equalsIgnoreCase(AppModes.RDSI.toString())) && organisationNameObj.myTextBox.getValue().isEmpty() && individualNameObj.myTextBox.getValue().isEmpty() && positionNameObj.myTextBox.getValue().isEmpty()) {
