...
//				}
				...
				myTreeItem = Utilities.getSelectTreeItem(specificationObj.specificationObj.myTextBox.getValueBox().getName());					
				if (myTreeItem!=null) 
...
//		}			
	...
	public void setInterface(int i) {
		...
		else if (EUOSMEGWT.appMode.equalsIgnoreCase(AppModes.EENVPLUS.toString()) || EUOSMEGWT.appMode.equalsIgnoreCase(AppModes.RDSI.toString())) {
			specificationObj.setInterface(2);
			specificationObj.removeDisclosure();
			explanationObj.setMyValue(constants.explanationValue());
			explanationObj.setVisible(false);			
