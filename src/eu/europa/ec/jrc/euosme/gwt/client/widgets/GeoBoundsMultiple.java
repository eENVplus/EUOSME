		...
		if (fromWhere=="newButton") {
			...
			if (i==1) {
				...
				if (Utilities.getSelectTreeItem(myFormName + ".ex_geographicboundingbox[1]")==null) {
					...
					SafeHtml safeHtml = SafeHtmlUtils.fromString(constants.XMLValue() + newItem.split(";")[3]);
					TreeItem myValueW = new TreeItem(safeHtml);
					...
					safeHtml = SafeHtmlUtils.fromString(constants.XMLValue() + newItem.split(";")[1]);
					TreeItem myValueE = new TreeItem(safeHtml);
					...
					safeHtml = SafeHtmlUtils.fromString(constants.XMLValue() + newItem.split(";")[2]);
					TreeItem myValueS = new TreeItem(safeHtml);
					...
					safeHtml = SafeHtmlUtils.fromString(constants.XMLValue() + newItem.split(";")[0]);
					TreeItem myValueN = new TreeItem(safeHtml);
